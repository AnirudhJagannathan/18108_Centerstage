        ...
        while (opModeInInit()) {
            {
                ...
                traj2 = drive.trajectoryBuilder(traj1.end())
                        .lineToLinearHeading(new Pose2d(34.5, -12.5, Math.toRadians(90)))
                        .build();
                ...
                traj4 = drive.trajectoryBuilder(traj3.end())
                        .lineToLinearHeading(new Pose2d(62.75, -14, Math.toRadians(-90)),
                ...
                traj5 = drive.trajectoryBuilder(traj4.end())
                        .lineToLinearHeading(new Pose2d(62, 78, Math.toRadians(-90)),
                        ...
                        .addSpatialMarker(new Vector2d(61, 52), () -> {
                            slides.moveSlidesToHeightABS(1100, 1.0);
                        })
                        .build();

                traj6 = drive.trajectoryBuilder(traj5.end())
                        .lineToLinearHeading(new Pose2d(31, 92.5, Math.toRadians(-90)))
                ...
                traj8 = drive.trajectoryBuilder(traj7.end())
                        .lineToLinearHeading(new Pose2d(62, -14.5, Math.toRadians(-90)),
                                SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                ...
                traj10 = drive.trajectoryBuilder(traj9.end())
                        .lineToLinearHeading(new Pose2d(36.5, 92.5, Math.toRadians(-90)))
                        .addSpatialMarker(new Vector2d(48, 70), () -> {
                            fourBar.lowerFourBar();
                            spintake.stop();
                        })
                    ...
                    /** -------------------------------------------------------------------------------------
                     ...
                     ------------------------------------------------------------------------------------- */
                    traj1 = drive.trajectoryBuilder(startPose)
                            .lineToLinearHeading(new Pose2d(35, -12, Math.toRadians(30)))
                            .addSpatialMarker(new Vector2d(12, 2), () -> {
                                launcher.trayStickOut();
                            })
                            .build();
                    ...
                    traj2 = drive.trajectoryBuilder(traj1.end())
                            .lineToLinearHeading(new Pose2d(41, -20, Math.toRadians(125)))
                            .build();
                    ...
                    traj10 = drive.trajectoryBuilder(traj9.end())
                            .lineToLinearHeading(new Pose2d(40, 92.25, Math.toRadians(-90)))
                            .addSpatialMarker(new Vector2d(48, -70), () -> {
                                fourBar.lowerFourBar();
                                spintake.stop();
                            })
                    ...
                    traj4 = drive.trajectoryBuilder(traj3.end())
                            .lineToLinearHeading(new Pose2d(62, -14, Math.toRadians(-91)),
                                    SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .addSpatialMarker(new Vector2d(61.25, 10), () -> {
                                launcher.trayStickOut();
                    ...
                    traj5 = drive.trajectoryBuilder(traj4.end())
                            ...
                            .addSpatialMarker(new Vector2d(61, 55), () -> {
                                slides.moveSlidesToHeightABS(1175, 1.0);
                            })
                            .build();

                    traj6 = drive.trajectoryBuilder(traj5.end())
                            .lineToLinearHeading(new Pose2d(43, 92, Math.toRadians(-91)))
                            .addSpatialMarker(new Vector2d(48, 70), () -> {
                                fourBar.lowerFourBar();
                                spintake.stop();
                            })
                    ...
                    traj10 = drive.trajectoryBuilder(traj9.end())
                            .lineToLinearHeading(new Pose2d(39, 92.25, Math.toRadians(-91)))
                            .addSpatialMarker(new Vector2d(48, 70), () -> {
                                fourBar.lowerFourBar();
                                spintake.stop();
                            })
