...
@Autonomous
public class BlueLeft2_2 extends LinearOpMode {
        ...
        while (opModeInInit()) {
            {
                ...
                if (pos == 1 && !posSet) {
                    ...
                    traj3 = drive.trajectoryBuilder(traj2.end())
                            .lineToLinearHeading(new Pose2d(31, 43.25, Math.toRadians(-91)),
                    ...
                    traj4 = drive.trajectoryBuilder(traj3.end())
                            .lineToLinearHeading(new Pose2d(13, 10, Math.toRadians(-91)),
                    ...
                    traj5 = drive.trajectoryBuilder(trajTruss.end())
                            .lineToLinearHeading(new Pose2d(36.5, -54, Math.toRadians(-90)),
                                    SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build();

                    trajIntake = drive.trajectoryBuilder(traj5.end())
                            .lineToLinearHeading(new Pose2d(36.5, -62, Math.toRadians(-90)))
                            .build();

                    traj6 = drive.trajectorySequenceBuilder(trajIntake.end())
                            .lineToLinearHeading(new Pose2d(36.5, -55, Math.toRadians(-90)))
                    ...
                    trajTruss2 = drive.trajectoryBuilder(traj6.end())
                            ...
                            .addSpatialMarker(new Vector2d(13, 10), () -> {
                                launcher.trayStickIn();
                                spintake.outtake();
                            })
                            .addSpatialMarker(new Vector2d(13, 15), () -> {
                                fourBar.closeClaw();
                            })
                            .build();

                    traj7 = drive.trajectoryBuilder(trajTruss2.end())
                            .lineToLinearHeading(new Pose2d(38, 42.5, Math.toRadians(-90)),
                                    ...
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .addSpatialMarker(new Vector2d(13, 31), () -> {
                                fourBar.raiseFourBar();
                            })
                            .addSpatialMarker(new Vector2d(16, 33.5), () -> {
                                slides.moveSlidesToHeightABS(1100, 1.0);
                            })
                            .build();

                    trajPark = drive.trajectoryBuilder(traj7.end())
                            .lineToLinearHeading(new Pose2d(10, 41, Math.toRadians(-90)),
                                    SampleMecanumDrive.getVelocityConstraint(0.7 * DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build();
                    ...
                    traj3 = drive.trajectoryBuilder(traj2.end())
                            .lineToLinearHeading(new Pose2d(38, 42.25, Math.toRadians(-91)))
                    ...
                    traj7 = drive.trajectoryBuilder(trajTruss2.end())
                            .lineToLinearHeading(new Pose2d(34, 42.5, Math.toRadians(-90)),
                                    SampleMecanumDrive.getVelocityConstraint(0.45 * DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .addSpatialMarker(new Vector2d(13, 31), () -> {
                                fourBar.raiseFourBar();
                    ...
                    traj3 = drive.trajectoryBuilder(traj2.end())
                            .lineToLinearHeading(new Pose2d(44, 43.25, Math.toRadians(-90)))
                    ...
                    traj4 = drive.trajectoryBuilder(traj3.end())
                            .lineToLinearHeading(new Pose2d(12, 10, Math.toRadians(-91)),
                                    SampleMecanumDrive.getVelocityConstraint(1.1 * DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .addSpatialMarker(new Vector2d(31, 43), () -> {
                                fourBar.raiseFourBar();
                    ...
                    trajTruss = drive.trajectoryBuilder(traj4.end())
                            ...
                            .addSpatialMarker(new Vector2d(12, 0), () -> {
                                fourBar.lowerFourBar();
                                launcher.trayStickOut();
                            })
                            .addSpatialMarker(new Vector2d(12, -35), () -> {
                                fourBar.openClaw();
                                spintake.stickIntake();
                            })
                            .build();
                    ...
                    trajTruss2 = drive.trajectoryBuilder(traj6.end())
                            .lineToLinearHeading(new Pose2d(12.5, 20, Math.toRadians(-90)))
                            .addSpatialMarker(new Vector2d(12.5, 10), () -> {
                                launcher.trayStickIn();
                                spintake.outtake();
                            })
                            .addSpatialMarker(new Vector2d(12, 15), () -> {
                                fourBar.closeClaw();
                            })
                            .build();

                    traj7 = drive.trajectoryBuilder(trajTruss2.end())
                            .lineToLinearHeading(new Pose2d(36, 42.5, Math.toRadians(-90)),
                                    SampleMecanumDrive.getVelocityConstraint(0.45 * DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
